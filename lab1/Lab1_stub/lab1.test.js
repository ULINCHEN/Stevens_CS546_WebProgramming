...
console.log(test("Case 1 ", [5, 3, 10], 147620,)(lab1.questionTwo));
console.log(test("Case 2 ", [2, 0, 2], 0,)(lab1.questionTwo));
console.log(test("Case 3 ", [512, 1007, -5], NaN,)(lab1.questionTwo));
console.log(test("Case 4 ", [2, 10, 4], 2222,)(lab1.questionTwo));
console.log(test("Case 5 ", [175, 3, 5], 21175,)(lab1.questionTwo));

console.log("function 3 test:");
console.log(test("Case 1 ", ["How now brown cow"], 10,)(lab1.questionThree));
console.log(test("Case 2 ", ["Welcome to CS-546"], 7,)(lab1.questionThree));
console.log(test("Case 3 ", ["JavaScript is fun!"], 10,)(lab1.questionThree));
console.log(test("Case 4 ", ["My name is YoulinChen"], 9,)(lab1.questionThree));
